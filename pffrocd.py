...
def run_sfe(x, y, y_0=None, y_1=None):
    ...
    CMD = f"./{EXECUTABLE_NAME} -r 0 -f {INPUT_FILE_NAME} -o {OUTPUT_FILE_NAME} -s 112 -x 0 & (./{EXECUTABLE_NAME} -r 1 -f {INPUT_FILE_NAME} -o {OUTPUT_FILE_NAME} -s 112 -x 0 2>&1 > /dev/null)"
